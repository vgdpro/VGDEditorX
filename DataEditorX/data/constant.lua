...
REASON_RDAMAGE		=0x8000		--回復轉換后的傷害
REASON_RRECOVER		=0x10000	--傷害轉換后的回復
...
SUMMON_TYPE_FLIP		=0x20000000	--反转召唤
...
STATUS_JUST_POS				=0x1000000	--已改变表示形式(用於STATUS_CONTINUOUS_POS判定)
